...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('settings')->insert([
            ...
            'first_tab' => json_encode(['Please enter your Amazon ORDER ID here. </br> Use the "FIND ID" button to get it easily from your Amazon Order History page.','*How long have you been using it?', 'Just started (less than 7 days)',"I've been using it for a while!",'I have been using it for more than 60 days.','*How satisfied are you with our product?
            ']),
            ...
            Please kindly support our growing business. <strong> Please save your review screenshot and return here to upload it </strong> , </br> so that you can unlock your benefit! Thank you for your business and your time!','Leave Feedback','Leave Feedback for the products on Amazon and claim all offers','Upload review screenshot']),
